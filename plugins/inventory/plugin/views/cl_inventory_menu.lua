...
function PANEL:rebuild()
  ...
  self.player_model:SetPos(w - self.player_model:GetWide())

  self.equipment_panel = vgui.create('DIconLayout', self)
  self.equipment_panel:SetSpaceX(math.scale_x(12))
  self.equipment_panel:SetSpaceY(math.scale(12))
  self.equipment_panel:SetSize(math.scale_x(216), h)
  self.equipment_panel:SetPos(self.player_model.x - self.equipment_panel:GetWide() - math.scale_x(8))
  self.equipment_panel:SetStretchHeight(true)
  ...
  self.equipment_panel:Add(self.equipment_mask)
  ...
  self.equipment_panel:Add(self.equipment_helmet)
  ...
  self.equipment_panel:Add(self.equipment_hands)
  ...
  self.equipment_panel:Add(self.equipment_torso)
  ...
  self.equipment_panel:Add(self.equipment_legs)
  ...
  self.equipment_panel:Add(self.equipment_back)
  ...
  self.equipment_panel:Add(self.equipment_accessories)
  ...
  local x = self.equipment_panel.x - self.main_inventory:GetWide() - math.scale(12)
