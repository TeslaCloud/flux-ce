...
lang["#PlayerGroup_Assistant"]       = "Административный ранг с низким уровнем доступа, для помощников администрации."
lang["#PlayerGroup_Moderator"]         = "Административный ранг для проверенных админов."
lang["#PlayerGroup_Admin"]     = "Административный ранг высшего уровня, имеющий доступ к большинству функций сервера."
