...
function PANEL:Init()
  ...
  self.back:SetSize(self.list:GetWide() / 4, theme.GetOption('menu_sidebar_button_height'))
...
function PANEL:Init()
  ...
  self.select:SetFont(theme.GetFont('text_normal_smaller'))
  ...
  self.delete:SetFont(theme.GetFont('text_normal_smaller'))
...
function PANEL:PerformLayout(w, h)
  ...
  self.select:SetPos(4, h - theme.GetOption('menu_sidebar_button_height'))
  self.select:SetSize(w / 3 * 2 - 4, theme.GetOption('menu_sidebar_button_height'))

  self.delete:SetPos(w / 3 * 2, h - theme.GetOption('menu_sidebar_button_height'))
  self.delete:SetSize(w / 3 - 4, theme.GetOption('menu_sidebar_button_height'))
end
