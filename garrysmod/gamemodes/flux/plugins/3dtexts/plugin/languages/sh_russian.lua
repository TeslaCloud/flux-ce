...
lang["#3DText_NotEnoughText"]  = "Вы указали недостаточное количество текста."
lang["#3DText_TextAddDesc"]    = "Добавляет 3D тексты на поверхности."
lang["#3DText_TextAddSyntax"]  = "<текст> [размер = 1] [стиль = 1] [цвет = #FFFFFF] [доп. цвет = #FF0000]"
lang["#3DText_TextAdded"]    = "Вы добавили текст."
lang["#3DText_TextRemoved"]    = "Вы удалили текст."
...
lang["#tool.texts.opt7"]    = "Текст в Табличке (вариант 2)"
lang["#tool.texts.opt8"]    = "Текст в Табличке (вариант 3)"
lang["#tool.texts.opt9"]    = "Текст в Табличке (вариант 4)"
lang["#tool.texts.opt91"]    = "Текст в Табличке (блюр)"
